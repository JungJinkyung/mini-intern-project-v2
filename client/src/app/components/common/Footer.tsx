export default () => {
  return (
    <footer className="text-gray-800 h-[330px] border-t border-gray-200">
      <div className="grid grid-cols-3 w-[1140px] h-3/5 mx-auto mt-14">
        <div className="px-4">
      ...
      <div className="text-center text-[#B8B7B7] py-6 text-[10px] border-t mt-4">
        <p>이용약관 개인정보처리방침</p>
